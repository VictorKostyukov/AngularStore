...
//  or if sku is passed get total price of items with this sku
...
// get the total price for all items currently in the cart;
//  or if sku is passed get count of items with this sku
...
shoppingCart.prototype.checkout = function (serviceName, clearCart) {
    ...
    switch (parms.serviceName) {
        case "PayPal":
            this.checkoutPayPal(parms, false);
            break;
        case "Google":
            this.checkoutGoogle(parms, false);
            break;
        default:
