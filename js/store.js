...
store.prototype.loadProductsFromFile = function ($http) {

    $http.get('data/products.json').success(function(data) {
        // !!! doesn't work !!!
        // this doesn't pointing to store
        // this.products = data
  });
}

store.prototype.generateProducts = function () {
...
// need temporary to export produts from JavaScript to JSON
store.prototype.showProductsAsJSON = function() {
    if (JSON != null) {
